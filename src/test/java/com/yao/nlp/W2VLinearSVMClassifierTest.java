...
public class W2VLinearSVMClassifierTest {

    public static final String CORPUS_FOLDER = "data/测试训练2";
    /**
     * 模型保存路径
     */
    public static final String MODEL_PATH = "data/测试训练2_W2V_SVM.ser";
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        IClassifier classifier = new W2VLinearSVMClassifier(trainOrLoadModel(docVectorModel),docVectorModel);
    ...
    private static LinearSVMModel trainOrLoadModel(DocVectorModel docVectorModel) throws IOException
    {
        ...
        IClassifier classifier = new W2VLinearSVMClassifier(docVectorModel);  // 创建分类器，更高级的功能请参考IClassifier的接口定义
